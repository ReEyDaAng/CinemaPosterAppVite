...
export default function Banner({ movie }) {
  ...
  const dateLabel = (() => {
    if (!movie.release_date) return 'Дата невідома';
    const d = parseISO(movie.release_date);
    return isValid(d) ? format(d, 'dd.MM.yyyy') : 'Дата невідома';
  })();
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent
                      p-10 pb-[53px] flex flex-col justify-end text-white">
        ...
        <div className="flex items-center gap-4">
          <button
            className="bg-purple-600 hover:bg-purple-700 px-6 py-2
                       rounded-[14px] h-[54px] w-[180px] whitespace-nowrap
